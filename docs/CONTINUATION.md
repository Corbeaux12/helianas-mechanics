...
- **Module version:** 1.12.0 deployed. Everything through commit `dc435d6` is live on the server.
...
- **Hunt items: 12 of 27 hunts imported** (`tools/data/hunts/*.json`). Latest batch: The Good, The Bad, and the Oni (Pepper Oni) and Bones N' Roses (Amalgamooze) — 21 new recipe pages, all verified linked.
