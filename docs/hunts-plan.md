...
**Field-notes actors (new phase, started):** `tools/data/actors/*.json` → hunt-bestiary Actor pack. Done so far (27): Briar Lord (X-38), Zaptor Matriarch + Zaptor (P-006), Mosslax (P-002), Grief Jinn (P-003), Giblin (P-005), Magnétanque (X-21), Somnoblin (X-23), Purrmafrost (X-27), Hivebound Captain (P-001), Skyslumbre (P-004), Teneblaze (P-008), Empathrem (P-009), Stonemaw (X-25), Obakitsu (X-26), Kougaï (P-010), Shahoko (P-011), Enkon (P-012), Painted Lady (X-20, incl. lair), Bicephal Wyrmhole (X-22), High Priest of the Astringentum (X-24), Bladeborne Mantiroar (X-28, incl. lair), Reef Avatar (X-29, incl. lair), Necropod (X-31), Sea Giant (X-32), Deep Gazer (X-33), Chuulverin (X-34). All 45 field-note PDFs are text-extracted in the scratchpad; ~18 stat blocks remain (some PDFs carry two), one transcription each.
