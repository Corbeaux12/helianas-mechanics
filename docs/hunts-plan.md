...
**Field-notes actors (new phase, started):** `tools/data/actors/*.json` → hunt-bestiary Actor pack. Done so far (15): Briar Lord (X-38), Zaptor Matriarch + Zaptor (P-006), Mosslax (P-002), Grief Jinn (P-003), Giblin (P-005), Magnétanque (X-21), Somnoblin (X-23), Purrmafrost (X-27), Hivebound Captain (P-001), Skyslumbre (P-004), Teneblaze (P-008), Empathrem (P-009), Stonemaw (X-25), Obakitsu (X-26). All 45 field-note PDFs are text-extracted in the scratchpad; ~30 stat blocks remain (some PDFs carry two), one transcription each.
